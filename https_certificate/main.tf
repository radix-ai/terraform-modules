...
Create a verified HTTPS certificate [1] for a list of domains.

Note: you must foresee a provider in the us-east-1 region to host the https
certificate for compatibility with CloudFront [3].
...
[3] https://docs.aws.amazon.com/acm/latest/userguide/acm-regions.html
